...
public class Constants {
	...
	public static String USER_NAME = "bartouil"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "R]jG7TX"; // votre mot de passe . XXX
	...
	public static String CT_BASE_NAME = "ct-tpiss-virt-C2-ct1";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
